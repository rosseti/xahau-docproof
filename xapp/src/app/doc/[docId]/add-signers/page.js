...
import { addAuthorizedSigners, getDocument } from "@/services/APIService";
...
export default function PageAddSigners() {
  ...
  const handleSubmit = async (event) => {
    ...
    await addAuthorizedSigners(docId, authorizedSigners).then(({ data }) => {
      ...
      <div className="container mx-auto pt-10 px-4 w-100">
        <div className="grid grid-cols-2 gap-4">
          <div className="p-4">
            ...
            <div className="badge badge-primary badge-outline">{document.name}</div>
          </div>
          <div className="p-4">
            <h2 className="text-4xl font-bold pb-4">Add Signers</h2>

            <p className="mb-4">Here you can add the emails of the people that will be able to sign the document.</p>
