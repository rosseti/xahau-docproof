...
export default function WalletSelection() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-base-200 p-8">
      <h1 className="text-5xl font-bold mb-12 text-primary">Signing Options</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">

        <Link href="/origo/sign/legacy" className="block">
          <div className="card bg-base-100 shadow-2xl hover:shadow-3xl transition-shadow duration-300 cursor-pointer h-full">
            <div className="card-body flex flex-col items-center justify-center text-center">
              <h2 className="card-title text-3xl mb-4">Legacy Sign (via PFX)</h2>
              <p className="text-lg mb-6">Use a PFX certificate for secure signing.</p>
              <button className="btn btn-primary btn-lg w-full">Go Legacy!</button>
            </div>
          </div>
        </Link>
        ...
        <Link href="/origo/sign/wallet" className="block">
          <div className="card bg-base-100 shadow-2xl hover:shadow-3xl transition-shadow duration-300 cursor-pointer h-full">
            <div className="card-body flex flex-col items-center justify-center text-center">
              ...
              <button className="btn btn-primary btn-lg w-full">Go Xaman!</button>
            </div>
          </div>
        </Link>
      </div>
